...
<form action="edit_infor/<?php echo $row["MaNV"] ?>" method="POST">
    <div class="modal-body mx-3 row">
        <div class="col-md-6">
            <div class="md-form mb-5">
                <i class="fas fa-envelope prefix grey-text"></i>
                <label data-error="wrong" data-success="right">Mã nhân sự</label>
                <input type="text" name="MaNV" id="MaNV" class="form-control validate" disabled value="<?php echo $row["MaNV"] ?>">
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="md-form mb-4">
                ...
                <input type="integer" name="MaPB" class="form-control validate" disabled value="<?php echo $row["TenPB"] ?>">
            </div>
            <div class="md-form mb-4">
                <i class="fas fa-lock prefix grey-text"></i>
                <label data-error="wrong" data-success="right" for="defaultForm-pass">Tên chức vụ</label>
                <input type="integer" name="MaPB" class="form-control validate" disabled value="<?php echo $row["TenCV"] ?>">

            </div>
            <div class="md-form mb-4">
                <i class="fas fa-lock prefix grey-text"></i>
                <label data-error="wrong" data-success="right" for="defaultForm-pass">Mức lương</label>
                <input type="integer" name="Mucluong" class="form-control validate" disabled value="<?php echo $row["Mucluong"]?>">
            </div>
        </div>

    </div>
    <div class="modal-footer d-flex justify-content-center">
        <button name="edit_infor" class="btn btn-success">Send</button>
    </div>
</form>